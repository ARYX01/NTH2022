...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_svelte_frappe_charts: string;
	export const npm_package_dependencies_svelte_markdown: string;
	export const npm_package_dependencies_svelte_materialify: string;
	export const npm_package_dependencies_vite_plugin_markdown: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_svelte_frappe_charts: string;
		npm_package_dependencies_svelte_markdown: string;
		npm_package_dependencies_svelte_materialify: string;
		npm_package_dependencies_vite_plugin_markdown: string;
